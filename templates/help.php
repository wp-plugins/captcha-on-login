...
<h2><?php _e('Help',self::CLASS_NAME);?> <?php echo self::PLUGIN_NAME?>:</h2>
...
<p>
<?php _e('For more help and more details, visit the plugin page',self::CLASS_NAME);?> <a href="<?php echo self::PLUGIN_PAGE?>" target="_blank"><?php echo self::PLUGIN_PAGE?></a>
</p>
<hr />
